...
int main()
{
    ...
    //Initializing element names and electronic configurations.
    {
                    ...
                    strcpy(elem[115].name,"Moscovium- Mc");      strcpy(elem[115].ec,"[Rn] 5f14 6d10 7s2 7p3");
                    strcpy(elem[116].name,"Livermorium- Lv");    strcpy(elem[116].ec,"[Rn] 5f14 6d10 7s2 7p4");
                    strcpy(elem[117].name,"Tennessine-Ts");      strcpy(elem[117].ec,"[Rn] 5f14 6d10 7s2 7p5");
                    strcpy(elem[118].name,"Oganesson- Og");      strcpy(elem[118].ec,"[Rn] 5f14 6d10 7s2 7p6");
    }
    //Initializing atomic weight, atomic radius and electronegativity.
    {
                   ...
                   elem[114].atomicw=287;           elem[114].atomicr=0;           elem[114].en=0;
                   elem[115].atomicw=288;           elem[115].atomicr=0;           elem[115].en=0;
                   elem[116].atomicw=291;           elem[116].atomicr=0;           elem[116].en=0;
    ...
    //Initializing melting point , boiling point and density.
    {
                   ...
                   elem[115].meltp=0;              elem[115].boilp=0;              elem[115].density=13.5;
                   elem[116].meltp=0;              elem[116].boilp=0;              elem[116].density=0;
                   elem[117].meltp=0;              elem[117].boilp=0;              elem[117].density=0;
                   elem[118].meltp=0  ;            elem[118].boilp=368;            elem[118].density=5;
    }
...
strcpy(elem[115].origin,"Moscow, Place in Russia");
strcpy(elem[116].origin,"Lawrence livermore National Laboratory, Lb in California");
strcpy(elem[117].origin,"Tennessee, Place");
strcpy(elem[118].origin,"Yuri Oganessian, physicist");
